...
* Creating features
  ...
  the layout and look of a freshly installed B-Translator Client site):
  #+BEGIN_EXAMPLE
...
* Making features configurable
  ...
  administrator/maintainer of the (B-Translator Client) application an easy
  ...
  function bcl_googleanalytics_menu() {
    $items = array();
    $items['admin/config/bcl/googleanalytics'] = array(
  ...
  section of B-Translator Client configurations. This admin/config page
